"""
Matching the aphia ID to worms database to derive taxonomic hierarchy.
The script uses /data/1.harvest_wp2_observation_data and
/data/2.harvest_wp3_sensor_observation_data as input, and produces
/data/worms/worms_call1_data and /data/worms/worms_sensor_data as output.
Each output file is a JSON list of dicts with keys "taxonomy"
(list of taxonomic ranks) and "count" (number of occurrences in the original
 CSV). The script also implements caching of WoRMS API responses to
 minimize redundant requests across runs.
"""
import pandas as pd
import requests
